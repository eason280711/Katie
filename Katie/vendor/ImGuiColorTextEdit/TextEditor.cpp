...
const TextEditor::Palette& TextEditor::GetKatiePalette()
{
	const static Palette p = { {
			0xff7f7f7f,	// Default
			0xffd69c56,	// Keyword	
			...
			0xff206020, // Comment (single line)
			0xff406020, // Comment (multi line)
			ImGui::ColorConvertFloat4ToU32(ImVec4{0.261,0.257,0.341,0.6}), // Background
			0xffe0e0e0, // Cursor
			ImGui::ColorConvertFloat4ToU32(ImVec4{1,1,1,0.2}), // Selection
			0x800020ff, // ErrorMarker
			0x40f08000, // Breakpoint
			0xffffffff, // Line number
			ImGui::ColorConvertFloat4ToU32(ImVec4{0.131,0.129,0.171,0.3}), // Current line fill
			ImGui::ColorConvertFloat4ToU32(ImVec4{0.196,0.193,0.254,0.3}), // Current line fill (inactive)
			ImGui::ColorConvertFloat4ToU32(ImVec4{0.196,0.193,0.254,0.2}), // Current line edge
		} };
	return p;
}
